<?
	...
	//if ($gubun == "MOBILE")
		//echo "<script>location.href='http://www.belif-factory.com/MOBILE/index.belif?media=".$_SESSION['ss_media']."';</script>";
?>
<!doctype html>
  <html>
    <head>
      ...
      <meta property="og:url" content="http://www.belif-factory.com/MOBILE/index.belif" />
