...
<?php 
	...
	$buyer_list_query = "SELECT * FROM ".$_gl['member_info_table']." WHERE mb_name <> 'admin' AND mb_name <> 'tfs_admin' ".$where." Order by idx DESC LIMIT $PAGE_CLASS->page_start, $page_size";
